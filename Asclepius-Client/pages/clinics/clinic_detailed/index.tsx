...
const BranchActions = () => {
  ...
  return (
    <div className={styles.branchActions}>
      ...
      <ReactSelect options={options} className={styles.filter}></ReactSelect>
      ...
      <div className={styles.pageBody}>
        <div className={styles.row}>
          <div className={styles.colSmall}>
            <Card className={styles.smallCard}>
              ...
              />
              <div className={styles.clinicName}>Medical House</div>
              <div className={styles.clinicRating}>
                ...
                ></StarRatings>
                <span className={styles.clinicRatingCount}>4</span>
              ...
              <div className={styles.clinicInf}>
                <ReactSVG
                  ...
                  className={styles.iconContainer}
                />
                <span className={styles.clinicInfText}>10:00-20:00</span>
              </div>
              <div className={styles.clinicInf}>
                <ReactSVG
                  ...
                  className={styles.iconContainer}
                />
                <span className={styles.clinicInfText}>480-555-0103</span>
              </div>
              <div className={styles.clinicInf}>
                <ReactSVG
          ...
          <div className={styles.colLarge}>
            <Card
              ...
              cardActions={<EditAction icon="/images/icons/inputs/edit.svg" />}
            >
              <div className={styles.dataRow}>
                <div className={styles.dataIndex}>E-mail</div>
                <div className={styles.dataValue}>MedHouse@gmail.com</div>
              </div>
              <div className={styles.dataRow}>
                <div className={styles.dataIndex}>Amount of orders</div>
                <div className={styles.dataValue}>128</div>
              </div>
              <div className={styles.dataRow}>
                <div className={styles.dataIndex}>Registration date</div>
                <div className={styles.dataValue}>05.11.2018</div>
              </div>
              <div className={styles.dataRow}>
                <div className={styles.dataIndex}>E-mail</div>
                <div className={styles.dataValue}>MedHouse@gmail.com</div>
              ...
              <div className={styles.dataRow}>
                <div className={styles.dataIndex}>About clinic</div>
        ...
        <div className={styles.tabContainer}>
          <Tabs>
            ...
            <TabPanel className={tabStyles.tabPanel}>Offers</TabPanel>
            <TabPanel className={tabStyles.tabPanel}>Stuff</TabPanel>
            <TabPanel className={tabStyles.tabPanel}>Photo gallery</TabPanel>
          </Tabs>
        </div>
      </div>
    </div>
