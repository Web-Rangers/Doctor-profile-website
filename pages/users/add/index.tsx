    ...
    <div className={pageStyles.container}>
      ...
      <div className={pageStyles.pageBody}>
        ...
        <Card cardTitle="Contacts">
          <div className={styles.row}>
            <div className={classNames(styles.columnLeft, styles.halfw)}>
              <Select
                label="City"
                labelStyle="outside"
                onChange={() => {}}
            ...
            <div className={classNames(styles.columnRight, styles.halfw)}>
        ...
        <Card cardTitle="Card">
          <div className={styles.row}>
            ...
            <div className={classNames(styles.columnRight, styles.halfw)}>
              <DatePicker mode="single" label="Card valid until" />
            </div>
          </div>
        </Card>
