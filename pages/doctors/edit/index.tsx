...
import { getFreelancerDoctor, getDoctor } from 'components/useDoctorsData';
...
export default function EditDoctor() {
	...
	console.log('dododood', doctorData);
	if (router.isReady) {
		refetch();
	}
	...
	const [updateBody, setUpdateBody] = useState({
		...
		email: null,
		professionId: '1',
		personalId: doctorData?.idNumber,
		gender: doctorData?.gender,
		dateOfBirth: doctorData?.dateOfBirth,
		iban: doctorData?.iban,
		aboutMe: doctorData?.aboutMe,
		clinicBranchIds: doctorData?.clinicBranchIds,
		doctorType: doctorData?.doctorType,
		branch: null,
		pictureFile: doctorData?.pictureUrl,
	});

	useEffect(() => {
		doctorData?.contactInfos.filter((e) =>
			e?.type.value === 'mobile'
