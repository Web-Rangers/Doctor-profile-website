          ...
          <div className={styles.row}>
            <div className={styles.colSmall}>
              <Card className={styles.smallCard}>
                <img alt="" src={data?.logoUrl} className={styles.clinicIcon} />
                <div className={styles.clinicName}>{data?.displayName}</div>
                ...
                <div className={styles.clinicInf}>
                  <ReactSVG
                    ...
                    className={styles.iconContainer}
                  />
                  <span className={styles.clinicInfText}>{phoneNumber}</span>
                </div>
                <div className={styles.clinicInf}>
                  <ReactSVG
              ...
              <Card
                ...
                cardActions={
                  <EditAction
                    ...
                    onClick={() => setClinicEdtModalIsOpen(true)}
                  />
                }
              >
                ...
                <div className={styles.dataRow}>
                  ...
                  <div
                    className={classNames(styles.dataValue, {
