...
export default function AddClinicModal({
	...
	const addClinic = async () => {
		...
		return axios
			.post('/asclepius/v1/api/clinics/', formData, {
				headers: {
											...
											{workingHours[i].active ? (
												<>
													...
													<div className={styles.lineImg}>
														<img
															src='/images/icons/clinics/line.svg'
															alt=''
														/>
													</div>
													<Input
			...
			>
					...
					<div className={classNames(styles.modalContentRow, styles.center)}>
						<img
							...
							src={
								uploadPhoto !== ''
									? uploadPhoto
									: '/images/icons/clinics/placeholder.png'
							}
							alt=''
						/>
						<input
				...
				<div className={styles.modalActions}>
					...
					<Button
						...
						onClick={() => {
							{
								name && address ? addClinics() : alert('Fields are not filled');
							}
						}}
						size='large'
					/>
